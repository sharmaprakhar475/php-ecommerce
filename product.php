...
<title><?php echo $admin_site_title; ?> - Product Page</title>
    ...
    <div id="page-content">
    	...
    	<div class="page section-header text-center">
			<div class="page-title">
        		<div class="wrapper"><h1 class="page-width">Product Page</h1></div>
      		</div>
		</div>
        <!--End Page Title-->
        ...
        <div class="container collection-box">
        	<div class="row">
               <?php
                   $pquery1=mysqli_query($conn,"select * from product limit 8");
                   ...
                   <div class="colletion-item">
                       <a href="<?php echo "./product-layout-2.php?id=$p_id"; ?>">
