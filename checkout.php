...
<title><?php echo $admin_site_title; ?> - Checkout</title>
...
<div class="pageWrapper">
            ...
            <div class="row billing-fields">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 sm-margin-30px-bottom">
                    <div class="create-ac-content bg-light-gray padding-20px-all">
                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id="placeOrder" accept-charset="UTF-8">
                            <fieldset>
                                ...
                                <table class="bg-white table table-bordered table-hover text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $qt; ?></td>
                                            <td><?php echo "₹".($pr_price * $qt); ?></td>
                                            <?php $total=$total+($pr_price*$qt); ?>
                                            <?php $total_qty=$total_qty+$qt; ?>
                                        </tr>
                                        <?php
                                        }
                                        ?>
                            ...
                            <div class="payment-method">
                                <div class="payment-accordion">
                                    <div id="accordion" class="payment-section">
                                        ...
                                        <div class="card mb-2">
                                            <div class="card-header">
                                                <a class="collapsed card-link" data-toggle="collapse" href="#collapseFive">Cash On Delivery</a>
                                            </div>
                                            <div id="collapseFive" class="collapse" data-parent="#accordion">
                                                <div class="card-body">
                                                    <p class="no-margin font-15">Cash On Delivery!</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card mb-2">
    ...
    <!--End Scoll Top-->
     ...
     <script src="./IndianStates.js"></script>
     <script>
        function placeOrder(){
                const order={
                    ...
                    remark:document.getElementById("CartSpecialInstructions").value
                };
