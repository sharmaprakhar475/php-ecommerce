                                ...
                                <!-- <form method="post" action="http://annimexweb.com/cart/add" id="product_form_10508262282" accept-charset="UTF-8" class="product-form product-form-product-template hidedropdown" enctype="multipart/form-data">
                                    ...
                                    <div class="product-action clearfix">
                                        ...
                                        <div class="product-form__item--submit">
                                            ...
                                            <button href="./product-layout-2.php" type="button" name="add" class="btn product-form__cart-submit" onclick="add_cart(<?php echo $pr_id; ?> )">
                    ...
                    <div class="bredcrumbWrap">
                        ...
                        <div class="product-form__item--submit col-12" style="padding-bottom:20px">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-1"></div>
                                    <div class="col-2">
                                        <button type="button" onclick="requestCall(<?php echo $pr_id; ?>)" class="btn product-form__cart-submit">Submit</button>
                                    </div>
                                </div>
