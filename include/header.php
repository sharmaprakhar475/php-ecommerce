...
?>
  ...
  <div class="search">
            ...
            <div class="row">
                ...
                <div class="col-2 col-sm-4 col-md-3 col-lg-4 text-right">
                    ...
                    <ul class="customer-links list-inline">
                      ...
                      <?php }?>
                      <?php if(isset($_SESSION['user_id']) && isset($_SESSION['name'])){ ?>
                        <li><button onclick="logout()" style="color:white;">Logout</button></li>
                        <?php }?>
    ...
    ?>
    <div style="font-size:20px;color:white;background-color:grey;font-family:arial;padding-left:60px;"><u>Hi! <?php echo $_SESSION['name'];?></u></div>
    <?php } ?>
        <!--Header-->
            ...
            <div class="container-fluid">        
                <div class="row align-items-center">
                    ...
                    <div class="logo col-md-2 col-lg-2 d-none d-lg-block">
                        <a href="index.php">
                            <img src="<?php echo  $admin_logo_url; ?>" alt="<?php echo  $admin_logo_title; ?>" title="<?php echo  $admin_logo_title; ?>" />
                        </a>
                    </div>
                    <!--End Desktop Logo-->
                    ...
                    <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-block d-lg-none mobile-logo">
                        <div class="logo">
                            <a href="index.html">
                                <img src="<?php echo  $admin_logo_url; ?>" alt="<?php echo  $admin_logo_title; ?>" title="<?php echo  $admin_site_title; ?>" />
                            </a>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="col-4 col-sm-3 col-md-3 col-lg-2">
                            ...
                            <?php
                                ...
                                <li class="item">
                                	<a class="product-image" href="./cart.php">
                                    	<img src="<?php echo $product_img; ?>" alt="<?php echo $product_title; ?>" title="" />
                                    </a>
                        ...
                        <div class="site-header__search">
                            <button type="button" class="search-trigger" style="font-size:18px;"><a href="./my-orders.php">|Your orders|</a></button>
                        </div>
                        <div class="site-header__search">
...
<script type="text/javascript">
    ...
    (function(){
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/62933e6cb0d10b6f3e749509/1g47inmg5';
        s1.charset='UTF-8';
